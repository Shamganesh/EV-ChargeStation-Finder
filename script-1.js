...
// When the user clicks the button, modal opens, fetches JokeAPI, and displays it in 
the modal on screen. 
function jokey() { 
  
fetch("https://v2.jokeapi.dev/joke/Programming,Pun?blacklistFlags=nsfw,religious
 ,political,racist,sexist,explicit") 
  ...
  .then(data => { 
   ...
   localStorage.setItem('joke2',JSON.stringify(data.setup, 
'<br><br>',data.delivery)); 
